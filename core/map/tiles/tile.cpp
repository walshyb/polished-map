...
static unsigned char chip_priority_png_buffer[] = {
	0x89, 0x50, 0x4e, 0x47, 0x0d, 0x0a, 0x1a, 0x0a, 0x00, 0x00, 0x00, 0x0d, 0x49, 0x48, 0x44, 0x52,
...
void Tile::pixel(int x, int y, Hue h, unsigned char r, unsigned char g, unsigned char b) {
...
void Tile::clear() {
	...
	std::fill_n(_rgb, LINE_PX * LINE_PX * NUM_CHANNELS, (unsigned char)0xff);
}
...
void Tile::update_palettes(Palettes l) {
	for (int ty = 0; ty < TILE_SIZE; ty++) {
		for (int tx = 0; tx < TILE_SIZE; tx++) {
			Hue h = hue(tx, ty);
			const unsigned char *rgb = Color::color(l, _palette, h);
